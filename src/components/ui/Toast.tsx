  ...
  return (
    <AnimatePresence>
      {isOpen && (
        ...
        >
          <div className="flex items-center gap-3 p-4 rounded-xl bg-white border border-[#EAE5DC] shadow-2xl text-[#121316]">
            ...
            <div className="flex-1 text-sm text-slate-800 leading-snug font-medium">
              {message}
            </div>
            <button
              onClick={onClose}
